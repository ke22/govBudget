# story-page-visual-hierarchy-polish Specification

## Purpose

The hero's scroll indicator stays legible against the dark hero collage at every width, the page footer reads as visually distinct from the section above it even when they share the same background color, and the compact/intermediate hero stamp can grow without silently reopening the title-collision gap an earlier fix closed.
