# cjk-line-breaking Specification

## Purpose

Chinese body copy in the hero dek and story cards wraps at grammatically correct points, enforcing 禁則 punctuation rules instead of breaking mid-phrase or orphaning punctuation at a line boundary.
