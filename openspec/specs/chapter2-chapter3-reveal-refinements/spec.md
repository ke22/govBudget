# chapter2-chapter3-reveal-refinements Specification

## Purpose

Chapter 2's chart states and Chapter 3's grey baseline bar read as distinct, deliberate beats instead of everything appearing at once, and Chapter 3's existing exit choreography (chart following the last card) is documented as a guaranteed behavior rather than an unspecified side effect.
